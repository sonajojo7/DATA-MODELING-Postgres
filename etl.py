...
def process_song_file(cur, filepath):
    ...
    """
        This function reads JSON file song_data to get the data for 
        songs table and artists table.
        The needed data saved into song_data and artist_data
        Arguments:
        cur: Database Cursor
...
def process_log_file(cur, filepath):
    """
        This function reads log_data and gets data for
        time table, users table and songplays table 
        Time data is converted from timestamp to datetime.
        Arguments:
        cur: Database Cursor
